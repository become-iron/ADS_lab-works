...
FILE_STRING_FROM_DB = 'triplex_string_from_DB.txt'  # имя файла с трипл. строкой по данным из базы
...
results = [check_condition(trpString, condition, trpStringFromDB) for condition in conditions]  # результаты проверки
